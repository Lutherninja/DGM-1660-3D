...
//Name: Spacedoor.ma
//Last modified: Wed, Oct 25, 2017 12:55:58 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.6266574817675981 0.34734205321487277 17.151246198898839 ;
	setAttr ".r" -type "double3" 10.461647270389051 12.599999999999239 -2.0369018685217103e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "63D26A38-4996-ED73-D73C-5D95B9F50131";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.910444981935955;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.71289384365081787 0.50000000000321165 ;
	...
	setAttr -s 10 ".pt";
	setAttr ".pt[61]" -type "float3" 0 0.02353595 0 ;
	setAttr ".pt[62]" -type "float3" -1.8626451e-009 0.023535946 0 ;
	setAttr ".pt[63]" -type "float3" 2.3283064e-009 9.3132257e-010 0 ;
	setAttr ".pt[67]" -type "float3" -3.7252903e-009 3.7252903e-009 0 ;
	setAttr ".pt[68]" -type "float3" -3.7252903e-009 7.4505806e-009 0 ;
	setAttr ".pt[69]" -type "float3" 3.7252903e-009 -3.7252903e-009 0 ;
	setAttr ".pt[70]" -type "float3" 3.7252903e-009 0 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
createNode lightLinker -s -n "lightLinker1";
	rename -uid "0394B749-4ED5-FC53-3AD3-DD83AAE08647";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0A69EC34-4038-7F55-4B64-1CBC7653124D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EDBDD227-4313-4070-2A95-0CB7616D85A7";
createNode displayLayerManager -n "layerManager";
	rename -uid "436D8337-4B2E-FDC3-FB8C-8C98D5D208F3";
createNode displayLayer -n "defaultLayer";
	rename -uid "CE9BCC2B-45B5-3F4D-CA50-88B16CADC471";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B84A6441-4C57-F7D0-B3A1-76BB4DF766E5";
...
createNode polyTweak -n "polyTweak1";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[4]" -type "float3" 0.06150775 0.06150775 0 ;
	setAttr ".tk[5]" -type "float3" -0.06150775 0.06150775 0 ;
	setAttr ".tk[6]" -type "float3" -0.06150775 -0.06150775 0 ;
	setAttr ".tk[7]" -type "float3" 0.06150775 -0.06150775 0 ;
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 6 ".tk";
	setAttr ".tk[12]" -type "float3" 0 0 -0.13497937 ;
	setAttr ".tk[13]" -type "float3" 0 0 -0.13497937 ;
	setAttr ".tk[14]" -type "float3" 0 0 -0.13497937 ;
	setAttr ".tk[15]" -type "float3" 0 0 -0.13497937 ;
